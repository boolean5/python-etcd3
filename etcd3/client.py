...
class Etcd3Client(object):
    ...
    def get_range(self, range_start, range_end, **kwargs):
        ...
        :returns: sequence of (value, metadata) tuples when ``return_response``
                  is False and a response containing a header and the requested
                  key-value pairs when ``return_response`` is True
        """
